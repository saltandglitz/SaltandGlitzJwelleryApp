...
static String createOrder = /*appStrings.isNotEmpty
  ...
  static  String saltPromise = /*appStrings.isNotEmpty
      ? appStrings['saltPromise']
      :*/"The Salt Promise";
  static  String easyReturns = /*appStrings.isNotEmpty
      ? appStrings['easyReturns']
      :*/"30 Days Easy\nReturns";
  static  String oneYearWarranty = /*appStrings.isNotEmpty
      ? appStrings['oneYearWarranty']
      :*/"One Year\nWarranty";
  static  String hundredCertified = /*appStrings.isNotEmpty
      ? appStrings['hundredCertified']
      :*/"100%\nCertified";
  static  String lifeTimeExchange = /*appStrings.isNotEmpty
      ? appStrings['lifeTimeExchange']
      :*/"Lifetime Exchange\n& Buyback";
  static  String exclusiveDeals = /*appStrings.isNotEmpty
      ? appStrings['exclusiveDeals']
      :*/"Exclusive Deals";
  static  String curatedOnlyForYou = /*appStrings.isNotEmpty
  ...
  static String ringSize =
  appStrings.isNotEmpty ? appStrings['ringSize'] : 'Ring Size';
  ...
  appStrings.isNotEmpty ? appStrings['sizeText'] : 'Size';
  ...
  static String update = /*appStrings.isNotEmpty ? appStrings['update'] :*/ 'Update';
  ...
  static String ratingLogin = /* appStrings.isNotEmpty
      ? appStrings['ratingLogin']
      :*/ 'You want to rat this product, please log in first.';
  static String selectRating = /* appStrings.isNotEmpty
      ? appStrings['selectRating']
      :*/ 'Please select star rating.';
  static String enterFeedback = /* appStrings.isNotEmpty
      ? appStrings['enterFeedback']
      :*/ 'Please enter feedback';
  static String adminApproval = /* appStrings.isNotEmpty
      ? appStrings['adminApproval']
      :*/ 'Waiting For Admin Approval Rating';
  static String ratingUpdated = /* appStrings.isNotEmpty
      ? appStrings['adminApproval']
  ...
  static String sku =
  appStrings.isNotEmpty ? appStrings['sku'] : "SKU: JS02322-1YP900";
