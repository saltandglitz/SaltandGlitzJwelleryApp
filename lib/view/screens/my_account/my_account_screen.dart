                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color: controller.accountServiceColorLst[index],
                              borderRadius: BorderRadius.circular(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(controller.accountServiceTitleLst[index],
                                    style: semiBoldLarge.copyWith(
                                        color:
                                            ColorResources.conceptTextColor)),
                                Text(
                                    controller.accountServiceSubtitleLst[index],
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(
                                  color:
                                      controller.borderColorAnimation.value ??
