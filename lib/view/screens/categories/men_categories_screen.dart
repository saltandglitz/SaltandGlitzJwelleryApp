...
class MenCategoriesScreen extends StatelessWidget {
            ...
            GetBuilder(
              ...
              builder: (controller) {
                ...
                return ListView.builder(
                  itemCount:
                      (controller.menTopCategoriesImage.length / 2).ceil(),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            if (secondIndex <
                                controller.menTopCategoriesImage.length)
                              Flexible(
                                child: SizedBox(
                                  width: itemWidth,
                                  child: buildCategoryItem(
                        ...
                        if (controller.menExpandedIndex.value == firstIndex ||
                            controller.menExpandedIndex.value == secondIndex)
                          buildExpandedContent(controller,
                              controller.menExpandedIndex.value, size),
                      ],
                    );
                  },
                );
                  ...
                  itemBuilder: (context, rowIndex) {
                    ...
                    return Column(
                      children: [
                        ...
                        if (controller.menBrowsedExpandedIndex.value ==
                                firstIndex ||
                            controller.menBrowsedExpandedIndex.value ==
                                secondIndex)
                      ...
                      () => Row(
                        ...
                        children: List.generate(
                          ...
                          (i) => Padding(
                            ...
                            child: CircleAvatar(
                              radius: 5,
                              backgroundColor: ColorResources.inactiveCardColor,
                              child: CircleAvatar(
                                radius: 4,
                                backgroundColor:
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                      ...
                      margin: EdgeInsets.only(bottom: index == 2 ? 10 : 25),
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Column(
                            ...
                            children: [
                              Text(
                                controller.needHelpHeadingLst[index],
                              ...
                              Text(
                                controller.needHelpSubtitleLst[index],
                                style: semiBoldSmall.copyWith(
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    controller.menTopCategoriesName[index],
                    softWrap: true,
                    maxLines: 2,
                    style: semiBoldDefault.copyWith(
                        color: ColorResources.conceptTextColor),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const SizedBox(width: Dimensions.space10),
                  Text(
                    controller.mostMenBrowsedNamed[index],
                    style: semiBoldDefault.copyWith(
                        color: ColorResources.conceptTextColor),
                  ),
                  const SizedBox(width: Dimensions.space10),
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          typeDataShow == LocalStrings.giftsHim
                                              ? controller
                      ...
                      return Column(
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Text(
                                controller.menShopByNameLst[index],
                                textAlign: TextAlign.center,
                                softWrap: true,
                                maxLines: 2,
                                style: mediumDefault.copyWith(
