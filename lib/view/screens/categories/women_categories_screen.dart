  ...
  Widget buildCategoryItem(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isSelected
              ? ColorResources.buttonColor.withOpacity(0.04)
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    getCategoryData[index].category ?? '',
                    softWrap: true,
                    maxLines: 2,
                  ...
                  children: [
                    ...
                    if (controller.selectedTab.value == 1) ...[
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final innerCategory = innerSubCategoryList[index].key;
                          ...
                          return GestureDetector(
                            onTap: () {
                              ...
                              controller.filterCategoriesApiMethod(
                                ...
                                priceLimit: '',
                                filterLocallyByCategory: categoryName,
                ...
                children: [
                  SizedBox(
                    ...
                    child: ListView.builder(
                      itemCount:
                          getCategoryMostBrowsedData[index].subCategory?.length,
