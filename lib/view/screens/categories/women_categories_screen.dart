...
class WomenCategoriesScreen extends StatelessWidget {
          ...
          children: [
            ...
            Align(
              ...
              child: Text(LocalStrings.topCategories,
                  style: semiBoldLarge.copyWith(
                      color: ColorResources.buttonColorDark.withOpacity(0.7))),
            ),
            ...
            GetBuilder(
              ...
              builder: (controller) {
                ...
                final double itemWidth = (size.width - Dimensions.space30) / 2; // Adjust for spacing

                return ListView.builder(
                  itemCount:
                      (controller.womenTopCategoriesImage.length / 2).ceil(),
                  ...
                  itemBuilder: (context, rowIndex) {
                    ...
                    return Column(
                      children: [
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: Padding(
                                ...
                                child: buildCategoryItem(controller, firstIndex, size),
                              ),
                            ),
                            if (secondIndex < controller.womenTopCategoriesImage.length)
                              SizedBox(
                                width: itemWidth,
                                child: Padding(
                                  padding: const EdgeInsets.only(left: 10),
                                  child: buildCategoryItem(controller, secondIndex, size),
                                ),
                              ),
                            if (secondIndex >= controller.womenTopCategoriesImage.length)
                        ...
                        if (controller.expandedIndex.value == firstIndex ||
                            controller.expandedIndex.value == secondIndex)
                          buildExpandedContent(
                              controller, controller.expandedIndex.value, size),
                      ],
                    );
                  },
                );
            ...
            GetBuilder(
              ...
              builder: (controller) {
                ...
                final double itemWidth = (size.width - Dimensions.space30) / 2; // Adjust for spacing
                return ListView.builder(
                  itemCount: (controller.mostBrowsedImage.length / 2).ceil(),
                  physics: const NeverScrollableScrollPhysics(),
                  shrinkWrap: true,
                  itemBuilder: (context, rowIndex) {
                    final firstIndex = rowIndex * 2;
                    ...
                    return Column(
                      children: [
                          ...
                          children: [
                            ...
                            Flexible(
                              child: SizedBox(
                                width: itemWidth,
                                child:
                                    mostBrowsedItem(controller, firstIndex, size),
                              ),
                            ),
                            ...
                            if (secondIndex >= controller.mostBrowsedImage.length)
                            // Placeholder to maintain spacing if only one item is present
                              Flexible(
                                child: SizedBox(width: itemWidth),
                              ),
                        ...
                        if (controller.browsedIndex.value == firstIndex ||
                            controller.browsedIndex.value == secondIndex)
                  ...
                  return Stack(
                    ...
                    children: [
                      CarouselSlider.builder(
                        ...
                        // Add PageStorageKey
                        itemCount: controller.silverJewelleryImage.length,
                        ...
                        itemBuilder:
                          ...
                          return ClipRRect(
                            ...
                            child: CachedCommonImage(
                              networkImageUrl:
                                  controller.silverJewelleryImage[index],
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        margin: EdgeInsets.only(bottom: index == 4 ? 10 : 35),
                        decoration: BoxDecoration(
                            ...
                            gradient: index == 4
                                ...
                                : index == 3
                                    ? LinearGradient(
                                        colors: [
                                          ColorResources.helpNeedSecondColor,
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(
                                    Dimensions.offersCardRadius),
                                child: Image.asset(
                                    controller.needHelpImageLst[index]),
                              ),
                            ),
                            ...
                            Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(controller.needHelpHeadingLst[index],
                                    style: semiBoldDefault.copyWith(
                                        color:
                                            ColorResources.conceptTextColor)),
                                const SizedBox(height: Dimensions.space5),
                                Text(controller.needHelpTitleLst[index],
                                    style: semiBoldSmall.copyWith(
                                        color: ColorResources.conceptTextColor
                                            .withOpacity(0.5))),
                                Text(controller.needHelpSubtitleLst[index],
                                    style: semiBoldSmall.copyWith(
