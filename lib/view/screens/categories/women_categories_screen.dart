                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            if (secondIndex <
                                controller.womenTopCategoriesImage.length)
                              SizedBox(
                                width: itemWidth,
                                child: Padding(
          ...
          children: [
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    controller.womenTopCategoriesName[index],
                    softWrap: true,
                    maxLines: 2,
                    style: semiBoldDefault.copyWith(
                        color: ColorResources.conceptTextColor),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const SizedBox(width: Dimensions.space10),
                  Text(
                    controller.mostBrowsedNamed[index],
                    style: semiBoldDefault.copyWith(
                        color: ColorResources.conceptTextColor),
                  ),
                  const SizedBox(width: Dimensions.space10),
                                ...
                                children: [
                                  ...
                                  Positioned(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(
                                        child: Text(
                                          typeDataShow == LocalStrings.shopGifts
                                              ? controller
                                                  .shopGiftsNameLst[index]
                                              : controller
                                                  .moreJewelleryNameLst[index],
                                          textAlign: TextAlign.center,
                                          softWrap: true,
                                          maxLines: 2,
                                          style: semiBoldDefault.copyWith(
