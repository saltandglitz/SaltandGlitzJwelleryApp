                ...
                child: Column(
                  ...
                  placeOrderController.getAddress.isNotEmpty
                                  ...
                                  Obx(() {
                                    return Radio<int>(
                                      ...
                                      activeColor: ColorResources
                                          .conceptTextColor,
                                      onChanged: (value) {
                                        placeOrderController.selectAddress(value!);
                                        /// Add data radio selection time
                                        controller.streetNewAddress.text=placeOrderController.getAddress[index].street??'';
                                        controller.cityNewAddress.text=placeOrderController.getAddress[index].city??'';
                                        controller.stateNewAddress.text=placeOrderController.getAddress[index].state??'';
                                        controller.pinCodeNewAddress.text=placeOrderController.getAddress[index].postalCode??'';
                                        controller.countryNewAddress.text=placeOrderController.getAddress[index].country??'';
                                      },
                                    );
                                  }),
                                  const SizedBox(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        CommonTextField(
                                          ...
                                          hintText:
                                              LocalStrings.streetHouseNumber,
                                          hintTexStyle: mediumDefault,
                    ...
                    CommonButton(
                        ...
                        onTap: placeOrderController.isCreateOrder.value == true
                            ...
                            : () {
                                ...
                                controller.createOrderApiMethod(
                                  ...
                                  streetDifferentAddress: controller
                                      .streetDifferentAddress.text
                                      .trim(),
                                  cityDifferentAddress: controller
                                      .cityDifferentAddress.text
                                      .trim(),
                                  stateDifferentAddress: controller
                                      .stateDifferentAddress.text
                                      .trim(),
                        ...
                        child: Obx(
                          () {
                            return placeOrderController.isCreateOrder.value ==
                                    true
                                ? const Center(
                                    child: Padding(
                                ...
                                : Text(
                                    LocalStrings.continuePlaceOrder
                                        .toUpperCase(),
                                    style: boldMediumLarge.copyWith(
                                      color: ColorResources.whiteColor,
                                    ),
