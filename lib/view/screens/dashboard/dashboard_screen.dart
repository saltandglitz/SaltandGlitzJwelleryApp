                ...
                children: [
                  ListView(
                    ...
                    children: [
                      ...
                      /* Banner images */
                      bottomBannerList.isEmpty ? const SizedBox() : GetBuilder(
                        init: MainController(),
                        builder: (ctrl) {
                                                ...
                                                child: Card(
                                                  ...
                                                  child: ClipRRect(
                                                      ...
                                                      VisibilityDetector(
                                                        ...
                                                        child: Obx(() {
                                                          bool isReady = controller
                                                              .isVideoReadyList
                                                              .length > index &&
                                                              controller
                                                                  .isVideoReadyList[index] ==
                                                                  true;
                          ...
                          children: [
                            ...
                            Text(
                              "${PrefManager.getString(
                                  "firstName")} ${PrefManager.getString(
                                  "lastName")}",
                              style: semiBoldMediumLarge.copyWith(
                                color: ColorResources.conceptTextColor,
                              ),
