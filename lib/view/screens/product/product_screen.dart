                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text("₹${LocalStrings.priceProductItemFirst}",
                                maxLines: 2,
                                softWrap: true,
                                style: semiBoldMediumLarge.copyWith()),
                            const SizedBox(height: Dimensions.space10),
                            RichText(
                              text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(
                                    text: " ${LocalStrings.priceBreakup}",
                                    style: mediumDefault.copyWith(
                                        color:
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    itemCount: controller.colorLst.length,
                                    shrinkWrap: true,
                                    padding: EdgeInsets.zero,
                                    ...
                                    itemBuilder: (context, index) {
                                      return GestureDetector(
                                        onTap: () {
                                          controller
                                              .colorSelectionJewellery(index);
                                        },
                                        child: Tooltip(
                                          message: controller
                                              .goldTypeMessageLst[index],
                                          verticalOffset: -45,
                                          child: Container(
                                            height: size.height * 0.020,
                                            width: size.width * 0.050,
                                            decoration: BoxDecoration(
                                              color: controller.colorLst[index],
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  ...
                                  child: ListView.builder(
                                    itemCount: controller.ctLst.length,
                                    shrinkWrap: true,
                                    padding: EdgeInsets.zero,
                                    scrollDirection: Axis.horizontal,
                                    physics:
                                    ...
                                    itemBuilder: (context, index) {
                                      return GestureDetector(
                                        onTap: () {
                                          controller
                                              .ktSelectionJewellery(index);
                                        },
                                        child: Tooltip(
                                          message: controller
                                              .ktTypeMessageLst[index],
                                          verticalOffset: -50,
                                          child: Container(
                                            height: size.height * 0.040,
                                            ...
                                            margin: EdgeInsets.only(
                                                right: index !=
                                                    ...
                                                    : 0),
                                            decoration: BoxDecoration(
                                              color: controller.ktCurrentIndex
                                                          .value ==
                                                      index
                                                  ? ColorResources
                                                      .buttonColorDark
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      LocalStrings.deliveryCancellation,
                                      style: mediumSmall.copyWith(
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  Row(
                                    children: [
                                      Image.asset(MyImages.gemstoneImage,
                                          height: 20),
                            ...
                            ListView.builder(
                              itemCount: controller.breakupItemLst.length,
                              shrinkWrap: true,
                                ...
                                return Column(
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        Text(
                                          controller.breakupItemLst[index],
                                          style: mediumDefault.copyWith(
                                              color:
                                                  ColorResources.borderColor),
                                        ),
                                        Text(
                                          controller.breakupItemPriceLst[index],
                                          style: mediumDefault.copyWith(
                                              color:
                                                  ColorResources.borderColor),
                                        ),
                            ...
                            const SizedBox(height: Dimensions.space15),
                            GridView.builder(
                              itemCount: controller.promiseImageLst.length,
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              gridDelegate:
                              ...
                              itemBuilder: (context, index) {
                                return Column(
                                  ...
                                  children: [
                                    Image.asset(
                                      controller.promiseImageLst[index],
                                      height: size.height * 0.050,
                                    ),
                                    const SizedBox(height: Dimensions.space5),
                                    Text(
                                      controller.promiseNameLst[index],
                                      style: mediumDefault.copyWith(
                                          color:
                                              ColorResources.conceptTextColor),
                                    ),
                                  ...
                                  RichText(
                                      ...
                                      text: TextSpan(
                                        children: [
                                          TextSpan(
                                            text:
                                                LocalStrings.jewelleryCertified,
                                            style: mediumLarge.copyWith(
                                                color: ColorResources
                                                    .conceptTextColor),
                                          ),
